...
void                fill_global_menu(t_gui_menu *my_menu, SDL_Renderer *renderer) //заполняем меню всего
{
    ...
    my_menu->controls[0] = create_controller(init_rect(3, 36, 160, 56), (t_gui_obj *)my_menu, "gui_textures/Button.png", &my_menu->scene->cam.dust);
    ...
    my_menu->radio[0] = create_radio(init_rect(3, 95, 418, 140), (t_gui_obj *)my_menu, "gui_textures/Button.png", &my_menu->scene->cam.effect);
