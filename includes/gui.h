...
typedef struct			s_label
{
	...
	void				(*draw)(SDL_Renderer *renderer,
							struct s_label *my_label);
	void				(*update)(struct s_label *my_label, char with_text,
...
typedef struct			s_button
{
	...
	void				(*draw)(SDL_Renderer *renderer,
							struct s_button *my_button);
	void				(*update)(struct s_button *my_button, char with_text,
							SDL_Renderer *renderer, char with_alph);
	t_gui_obj			*(*collision)(int x, int y, t_gui_obj *gui_obj);
}						t_button;

t_button				create_button(SDL_Rect my_rect, t_gui_obj *father,
							char *text);
void					button_settings(SDL_Renderer *renderer,
							t_button *my_button);
...
void					draw_button(SDL_Renderer *renderer,
							t_button *my_button);
t_gui_obj				*check_button_collision(int x, int y,
							t_gui_obj *gui_obj);
...
typedef struct			s_value_controler
{
	...
	void				(*draw)(SDL_Renderer *renderer,
							struct s_value_controler *my_control);
	void				(*update)(struct s_value_controler *my_control,
							char with_text, SDL_Renderer *renderer,
							char with_alph);
	t_gui_obj			*(*collision)(int x, int y, t_gui_obj *gui_obj);
}						t_val_control;

t_val_control			create_controller(SDL_Rect my_rect, t_gui_obj *father,
							char *text, float *value);
...
void					draw_controler(SDL_Renderer *renderer,
							t_val_control *my_control);
t_gui_obj				*check_contol_collision(int x, int y,
							t_gui_obj *gui_obj);
...
typedef struct			s_radio_button
{
	...
	void				(*draw)(SDL_Renderer *renderer,
							struct s_radio_button *my_radio);
	void				(*update)(struct s_radio_button *my_radio,
							char with_text, SDL_Renderer *renderer);
	t_gui_obj			*(*collision)(int x, int y, t_gui_obj *gui_obj);
}						t_radio_button;

t_radio_button			create_radio(SDL_Rect my_rect, t_gui_obj *father,
							char *text, int *value);
...
void					update_radio(t_radio_button *my_radio, char with_text,
							SDL_Renderer *renderer);
void					draw_radio(SDL_Renderer *renderer,
							t_radio_button *my_radio);
t_gui_obj				*check_radio_collision(int x, int y,
							t_gui_obj *gui_obj);
