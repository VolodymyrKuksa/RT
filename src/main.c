...
void init_torus(t_scene *scene)
{
	...
	tmp.primitive.triangle.d1 = (cl_float3){-5, -5, -20};
	tmp.primitive.triangle.d2 = (cl_float3){5, 5 ,-20};
	tmp.primitive.triangle.d3 = (cl_float3){5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 , -5, -20};
	tmp.color.x = 1.f;
	tmp.color.y = 0.f;
	tmp.color.z = 0.f;
	tmp.emission.x = 0.f;
...
//	tmp.basis.v = (cl_float3){0.0, 1.0, 0.0};
//	tmp.basis.w = (cl_float3){1.0, 0.0, 0.0};
//	tmp.primitive.paralellogram.pos.x = 0;
//	tmp.primitive.paralellogram.pos.y = 0;
//	tmp.primitive.paralellogram.pos.z = -24;
//	tmp.primitive.paralellogram.w = 3.f;
//	tmp.primitive.paralellogram.h = 5.f;
//	tmp.primitive.paralellogram.l = 10.f;
//	tmp.color.x = 1.f;
//	tmp.color.y = 0.f;
//	tmp.color.z = 0.f;
//	tmp.emission.x = 0.f;
...
//	tmp.primitive.rectangle.pos.z = -24;
...
//	tmp.primitive.rectangle.pos.x = 0;
//	tmp.primitive.rectangle.pos.y = 0;
//	tmp.primitive.rectangle.pos.z = -20;
//	tmp.primitive.rectangle.w = 5.f;
//	tmp.primitive.rectangle.h = 10.f;
//	tmp.color.x = 1.f;
//	tmp.color.y = 0.f;
...
//	tmp.primitive.rectangle.pos.x = 5;
//	tmp.primitive.rectangle.pos.y = 0;
//	tmp.primitive.rectangle.pos.z = -22;
//	tmp.primitive.rectangle.w = 2.f;
//	tmp.primitive.rectangle.h = 10.f;
//	tmp.color.x = 0.f;
//	tmp.color.y = 1.f;
//	tmp.color.z = 0.f;
...
//	tmp.basis.w = (cl_float3){0.0, 0.0, 1.0};
//	tmp.primitive.rectangle.pos.x = 0;
//	tmp.primitive.rectangle.pos.y = 10;
//	tmp.primitive.rectangle.pos.z = -22;
//	tmp.primitive.rectangle.w = 2.f;
//	tmp.primitive.rectangle.h = 5.f;
//	tmp.color.x = 0.f;
//	tmp.color.y = 0.f;
//	tmp.color.z = 1.f;
//	tmp.emission.x = 0.f;
